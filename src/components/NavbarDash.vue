      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          <button
            ...
            type="button"
            class="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:focus:ring-gray-600"
          >
          ...
          <a href="https://flowbite.com" class="flex ml-2 md:mr-24">
            <img src="../assets/img/columbia-logo.png" class="h-8 mr-3" alt="FlowBite Logo" />
          </a>
        </div>
          ...
          <div class="flex items-center ml-3">
            <div>
              ...
              >
                ...
                <LockClosedIcon
                  class="w-12 h-5 ml-2 -mr-1 hover:text-violet-100"
                  aria-hidden="true"
                />Cerrar Sesión
              </button>
            </div>
